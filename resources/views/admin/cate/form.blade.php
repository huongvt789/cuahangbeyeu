...
@section('content')
	...
	<form id="cate-form" action="{{ route('cate.save') }}" method="post" enctype="multipart/form-data" novalidate>
		...
		<div class="col-md-6">
			...
			<div class="form-group row">
				<lable class="col-md-3 control-lable">Đường dẫn <span class="text-danger">*</span></lable>
				<div class="col-md-9 div-cate-relative">
					<input id="slug" type="text" class="form-control" placeholder="Ví dụ: the-thao" name="slug" value="{{old('slug',$model->slug)}}">
			...
			<div class="form-group row">
				<lable class="col-md-3 control-lable">Danh mục cha</lable>
				<div class="col-md-9">
					<select name="parent_id" class="form-control">
						<option value="-1">-----------</option>
						@foreach($cates as $element)
							<option 
							@if($model->parent_id==$element->id) selected
							@endif
			...
			<div class="form-group row">
				<lable class="col-md-3 control-lable"></lable>
				<div class="col-md-9">
					<input 
					@if($model->is_menu==1) checked @endif
					id="isMenu" type="checkbox" name="is_menu" value="1">
					<lable for="isMenu">Hiển thị trang chủ</lable>
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group-row">
				<div class="col-md-offset-3">
					<img style="margin-left:8px; margin-bottom:5px" src="@if($model->image=="")
								{{asset('uploads/default-thumbnail.jpg')}}
							@else {{asset($model->image)}}
		...
		<div class="text-center">
			<a href="{{route('cate.index')}}" class="btn btn-danger">Hủy</a>
